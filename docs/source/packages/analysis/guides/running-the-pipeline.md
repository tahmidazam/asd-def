...
3. Summarise each class and align the classes to Litman's named classes:
   ...
   [reproducing the reference classes](../appendix/reproducing-the-reference-classes)).
...
investigation: [selecting the number of classes](../appendix/selecting-the-number-of-classes),
[stability under refitting](../appendix/stability-under-refitting),
[the minimum viable stratum size](../appendix/the-minimum-stratum-size), and
[replicating in the SSC](../appendix/replicating-in-the-ssc). The SSC milestone ages
